...
export const APIKEY_PROVIDERS = {
  ...
  cohere: { id: "cohere", alias: "cohere", name: "Cohere", icon: "hub", color: "#39594D", textIcon: "CO", website: "https://cohere.com", notice: { apiKeyUrl: "https://dashboard.cohere.com/api-keys" }, serviceKinds: ["llm", "reranker"], rerankerConfig: { baseUrl: "https://api.cohere.com/v2/rerank", authType: "apikey", authHeader: "bearer", format: "cohere", models: [{ id: "rerank-v3.5", name: "Rerank v3.5" }, { id: "rerank-english-v3.0", name: "Rerank English v3.0" }, { id: "rerank-multilingual-v3.0", name: "Rerank Multilingual v3.0" }] } },
  ...
  "voyage-ai": { id: "voyage-ai", alias: "voyage", name: "Voyage AI", icon: "data_array", color: "#0EA5E9", textIcon: "VG", website: "https://www.voyageai.com", notice: { apiKeyUrl: "https://dash.voyageai.com/api-keys" }, serviceKinds: ["embedding", "reranker"], embeddingConfig: { baseUrl: "https://api.voyageai.com/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "voyage-3-large", name: "Voyage 3 Large", dimensions: 1024 }, { id: "voyage-3.5", name: "Voyage 3.5", dimensions: 1024 }, { id: "voyage-3.5-lite", name: "Voyage 3.5 Lite", dimensions: 1024 }, { id: "voyage-code-3", name: "Voyage Code 3", dimensions: 1024 }, { id: "voyage-finance-2", name: "Voyage Finance 2", dimensions: 1024 }, { id: "voyage-law-2", name: "Voyage Law 2", dimensions: 1024 }, { id: "voyage-multilingual-2", name: "Voyage Multilingual 2", dimensions: 1024 }] }, rerankerConfig: { baseUrl: "https://api.voyageai.com/v1/rerank", authType: "apikey", authHeader: "bearer", format: "voyage", models: [{ id: "rerank-2.5", name: "Rerank 2.5" }, { id: "rerank-2.5-lite", name: "Rerank 2.5 Lite" }, { id: "rerank-2", name: "Rerank 2" }, { id: "rerank-2-lite", name: "Rerank 2 Lite" }] } },
  ...
  "lm-studio": { id: "lm-studio", alias: "lm-studio", name: "LM Studio", icon: "computer", color: "#7C3AED", textIcon: "LM", website: "https://lmstudio.ai", serviceKinds: ["llm", "tts", "stt", "reranker"], noAuth: true, rerankerConfig: { baseUrl: "http://localhost:1234/v1/reranking", authType: "none", authHeader: "none", format: "jina", models: [] }, ttsConfig: { baseUrl: "http://127.0.0.1:1234/v1/audio/speech", authType: "none", authHeader: "none", format: "openai", models: [{ id: "outetts-0.3-1b-instruct", name: "OuteTTS 0.3 1B Instruct" }, { id: "kokoro-82m", name: "Kokoro 82M" }] }, sttConfig: { baseUrl: "http://127.0.0.1:1234/v1/audio/transcriptions", authType: "none", authHeader: "none", format: "openai", models: [{ id: "whisper-large-v3", name: "Whisper Large v3" }, { id: "whisper-base", name: "Whisper Base" }] } },
  ...
  "jina-ai": { id: "jina-ai", alias: "jina", name: "Jina AI", icon: "blur_on", color: "#2563EB", textIcon: "JA", website: "https://jina.ai", notice: { text: "10M free tokens on signup (non-commercial), no credit card required.", apiKeyUrl: "https://jina.ai/?sui=apikey" }, serviceKinds: ["embedding", "reranker"], embeddingConfig: { baseUrl: "https://api.jina.ai/v1/embeddings", authType: "apikey", authHeader: "bearer", models: [{ id: "jina-embeddings-v3", name: "Jina Embeddings v3", dimensions: 1024 }, { id: "jina-embeddings-v2-base-en", name: "Jina Embeddings v2 Base EN", dimensions: 768 }, { id: "jina-embeddings-v2-base-code", name: "Jina Embeddings v2 Base Code", dimensions: 768 }] }, rerankerConfig: { baseUrl: "https://api.jina.ai/v1/rerank", authType: "apikey", authHeader: "bearer", format: "jina", models: [{ id: "jina-reranker-v2-base-multilingual", name: "Jina Reranker v2 Base Multilingual" }, { id: "jina-reranker-v1-turbo-en", name: "Jina Reranker v1 Turbo EN" }, { id: "jina-reranker-v1-base-en", name: "Jina Reranker v1 Base EN" }, { id: "jina-colbert-v2", name: "Jina ColBERT v2" }] } },
...
export const MEDIA_PROVIDER_KINDS = [
  ...
  { id: "reranker",    label: "Reranker",       icon: "sort",              endpoint: { method: "POST", path: "/v1/reranking" } },
