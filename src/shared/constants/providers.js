...
export const APIKEY_PROVIDERS = {
  ...
  "lm-studio": { id: "lm-studio", alias: "lm-studio", name: "LM Studio", icon: "computer", color: "#7C3AED", textIcon: "LM", website: "https://lmstudio.ai", serviceKinds: ["llm", "reranker"], noAuth: true, rerankerConfig: { baseUrl: "http://127.0.0.1:1234/v1/reranking", authType: "none", authHeader: "none", format: "jina", models: [] } },
